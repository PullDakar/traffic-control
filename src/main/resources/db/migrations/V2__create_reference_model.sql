...
INSERT INTO road_controller_program (id, road_controller_id, program_name, phase_count) values ( 1, 33051, 'LOCAL', 3);
INSERT INTO road_controller_program (id, road_controller_id, program_name, phase_count) values ( 1, 33052, 'LOCAL', 3);
INSERT INTO road_controller_program (id, road_controller_id, program_name, phase_count) values ( 1, 33053, 'LOCAL', 3);
INSERT INTO road_controller_program (id, road_controller_id, program_name, phase_count) values ( 1, 33054, 'LOCAL', 3);
INSERT INTO road_controller_program (id, road_controller_id, program_name, phase_count) values ( 1, 33055, 'LOCAL', 3);
INSERT INTO road_controller_program (id, road_controller_id, program_name, phase_count) values ( 1, 33056, 'LOCAL', 3);
INSERT INTO road_controller_program (id, road_controller_id, program_name, phase_count) values ( 1, 33057, 'LOCAL', 3);
INSERT INTO road_controller_program (id, road_controller_id, program_name, phase_count) values ( 1, 33058, 'LOCAL', 3);
INSERT INTO road_controller_program (id, road_controller_id, program_name, phase_count) values ( 1, 33059, 'LOCAL', 3);
INSERT INTO road_controller_program (id, road_controller_id, program_name, phase_count) values ( 1, 33060, 'LOCAL', 3);
