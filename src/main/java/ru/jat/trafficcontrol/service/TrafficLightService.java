...
public class TrafficLightService {
    ...
    private void saveTrafficLightStatus(Long id) {
        ...
        if (trafficLightStatusMap.containsKey(id)) {
            ...
            if (trafficLightStatus.getCurrentPhaseId() != previous.getCurrentPhaseId()) {
                var monitoringEntity = MonitoringEntity.builder()
                        .phaseId(trafficLightStatus.getCurrentPhaseId())
                        .programId(trafficLightStatus.getCurrentProgramId() != null ? trafficLightStatus.getCurrentProgramId() : 666)
                        .phaseDuration(previous.getTime() - trafficLightStatus.getTime())
                        .roadControllerId(id)
                        .build();
